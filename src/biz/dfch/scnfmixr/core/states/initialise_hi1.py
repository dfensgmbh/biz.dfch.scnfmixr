...
class InitialiseHi1(StateBase):
    """Human interface device 1 detection.
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            info_leave=UiEventInfo(
                StateEvent.INITIALISE_HI1_LEAVE, False)
        )
    ...
    def on_enter(self, ctx: ExecutionContext) -> None:
        ...
        msg = SystemMessage.InputEvent(InitialiseHi1.Event.DETECT_DEVICE)
