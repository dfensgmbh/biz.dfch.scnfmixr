...
class DetectingIn2(TransitionBase):
    """Detecting insert device IN2."""
    ...
    def __init__(self, event: str, target: StateBase):
        ...
        super().__init__(
            ...
            info_enter=UiEventInfo(
                TransitionEvent.DETECTING_DEVICE_IN2_ENTER, False),
            info_leave=UiEventInfo(
                TransitionEvent.DETECTING_DEVICE_IN2_LEAVE, False),
            target_state=target)
    ...
    def invoke(self, ctx):
        ...
        try:
            ...
            ctx.events.publish(SystemMessage.UiEventInfoTransitionLeaveMessage(
                UiEventInfo(
                    TransitionEvent.DETECTING_DEVICE_IN2_FAILED, False)))
