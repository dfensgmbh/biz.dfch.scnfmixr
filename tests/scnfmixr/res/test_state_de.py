...
from prep.snd.state_event_de import StateEventDe


class TestStateEventDe(unittest.TestCase):
    """Testing StateEvent definitions for DE."""
    ...
    def test_empty_keys(self):
        ...
        # Check if all keys are present in localized version.
        for key, value in StateEventDe.items():
