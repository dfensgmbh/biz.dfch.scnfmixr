...
Note: The hub the following internal port numbering, from left to the right (where the cable is): **3-2-1-4**. So, port 4 is the port directly next to the cable; port 3 is on the opposite end.
